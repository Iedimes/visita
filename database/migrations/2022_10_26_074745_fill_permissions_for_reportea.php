...
class FillPermissionsForReportea extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReportea constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.reportea',
            'admin.reportea.index',
            'admin.reportea.create',
            'admin.reportea.show',
            'admin.reportea.edit',
            'admin.reportea.delete',
            'admin.reportea.bulk-delete',
        ]);
