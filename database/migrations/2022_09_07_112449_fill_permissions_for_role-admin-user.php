...
class FillPermissionsForRoleAdminUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRoleAdminUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.role-admin-user.index',
            'admin.role-admin-user.create',
            'admin.role-admin-user.show',
            'admin.role-admin-user.edit',
            'admin.role-admin-user.delete',
            'admin.role-admin-user.bulk-delete',
        ]);
