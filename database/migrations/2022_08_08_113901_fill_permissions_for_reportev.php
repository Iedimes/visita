...
class FillPermissionsForReportev extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReportev constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.reportev',
            'admin.reportev.index',
            'admin.reportev.create',
            'admin.reportev.show',
            'admin.reportev.edit',
            'admin.reportev.delete',
            'admin.reportev.bulk-delete',
        ]);
