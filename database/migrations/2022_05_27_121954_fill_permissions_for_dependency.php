...
class FillPermissionsForDependency extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDependency constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dependency',
            'admin.dependency.index',
            'admin.dependency.create',
            'admin.dependency.show',
            'admin.dependency.edit',
            'admin.dependency.delete',
            'admin.dependency.bulk-delete',
        ]);
